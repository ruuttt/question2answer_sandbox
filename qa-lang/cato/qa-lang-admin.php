...
*/
	...
	return array(
		...
		'categories_introduction' => 'To get started with issues, click the \'Add Issue\' button.',
		'categories_not_shown' => 'Some actions have issues which will not be displayed.',
		'categories_title' => 'Issues',
		'categories' => 'Issues',
		'category_add_sub' => 'add sub-category',
		'category_added' => 'Issue added',
		...
		'category_no_add_subs_x' => 'This category cannot have sub-issues because it is already ^ levels down.',
		'category_no_delete_subs' => 'This category cannot be deleted because it has a sub-category.',
		'category_no_sub_error' => '^q action/s in this category have no sub-category - ^1set sub-category^2',
		'category_no_sub_to' => 'Move actions in ^ with no sub-category to:',
		'category_no_subs' => 'None',
		'category_none_error' => '^q action/s currently have no category - ^1set category^2',
		'category_none_to' => 'Move actions with no category to:',
		'category_parent' => 'Parent category:',
		'category_saved' => 'Issue saved',
		'category_slug' => 'Issue slug - URL fragment:',
		'category_subs' => 'Sub-issues:',
		...
		'delete_category_reassign' => 'Delete this category and reassign its actions to:',
		...
		'delete_hidden_note' => ' - all hidden actions, reaction and reaction on reactions without dependents',
		...
		'hidden_answers_deleted' => 'Deleted ^1 of ^2 hidden reactions without dependents...',
		'hidden_comments_deleted' => 'Deleted ^1 of ^2 hidden reaction on reactions...',
		'hidden_questions_deleted' => 'Deleted ^1 of ^2 hidden actions without dependents...',
		'hotness_factors' => 'Relative importance for action hotness:',
		'hidden_title' => 'Hidden',
		...
		'q2a_version' => 'Action2Reaction version:',
		'question_lists' => 'Action lists',
		'question_pages' => 'Action pages',
		'recalc_categories_backpaths' => 'Recalculating URL paths for ^1 of ^2 issues...',
		'recalc_categories_complete' => 'All issues were successfully recalculated.',
		'recalc_categories_note' => ' - for post issues and category counts',
		'recalc_categories_recounting' => 'Recounting actions for ^1 of ^2 issues...',
		'recalc_categories_updated' => 'Recalculated for ^1 of ^2 posts...',
		'recalc_categories' => 'Recalculate issues',
		...
		'recalc_posts_count' => 'Getting total number of actions, reactions and reaction on reactions...',
		...
		'recount_posts_as_recounted' => 'Recounted reactions and hotness for ^1 of ^2 posts...',
		'recount_posts_complete' => 'All posts were successfully recounted.',
		'recount_posts_note' => ' - the number of reactions, votes, flags and hotness for each post',
		...
		'refill_events_refilled' => 'Refilled for ^1 of ^2 actions...',
		'refill_events' => 'Refill event streams',
		'reindex_content' => 'Reindex content',
		'reindex_content_note' => ' - for searching and related action suggestions',
		...
		'requires_q2a_version' => 'Disabled - requires Action2Reaction ^ or later',
		...
		'tag_pages' => 'Tag pages',
		'tags_and_categories' => 'Tags and Issues',
		'tags_not_shown' => 'Some actions have tags which will not be displayed.',
		'tags' => 'Tags',
		'test_sent_to_x' => 'The test message was sent to ^',
		'title_already_used' => 'This value is already being used by another title',
		'top_level_categories' => 'Top level issues:',
		'total_as' => 'Total reactions:',
		'total_cs' => 'Total reaction on reactions:',
		'total_qs' => 'Total actions:',
		'unnamed_plugin' => 'Unnamed Plugin',
		'upgrade_db' => 'Your Action2Reaction database needs to be ^1upgraded^2 for this version.',
