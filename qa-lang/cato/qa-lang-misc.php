...
*/
	...
	return array(
		...
		'browse_categories' => 'Browse issues',
		...
		'feed_a_edited_prefix' => 'Reaction edited: ',
		'feed_a_prefix' => 'Reacted: ',
		'feed_a_reshown_prefix' => 'Reaction reshown: ',
		'feed_a_selected_prefix' => 'Reaction selected: ',
		'feed_c_edited_prefix' => 'Reaction on reaction edited: ',
		'feed_c_moved_prefix' => 'Reaction on reaction moved: ',
		'feed_c_prefix' => 'Reacted on reaction: ',
		'feed_c_reshown_prefix' => 'Reaction on reaction reshown: ',
		...
		'feedback_empty' => 'Please use this field to send some comnments or suggestions',
		...
		'no_favorite_categories' => 'No favorite issues',
		'no_favorite_qs' => 'No favorite actions',
		...
		'suggest_favorites_add' => 'To add an action or other item to your favorites, click the ^ at the top of its page.',
