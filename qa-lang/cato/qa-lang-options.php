...
*/
	...
	return array(
		...
		'allow_close_questions' => 'Allow actions to be manually closed:',
		'allow_login_email_only' => 'Only log in by email address (not username):', 
		'allow_multi_answers' => 'Allow multiple reactions per user:',
		'allow_no_category' => 'Allow actions with no category',
		'allow_no_sub_category' => 'Allow actions with a category but no sub-category',
		'allow_private_messages' => 'Enable private messaging between users:',
		'allow_self_answer' => 'Allow users to reaction their own action:',
		'allow_view_q_bots' => 'Allow search engines to view action pages',
		...
		'avatar_q_list_size' => 'Avatar size on action lists:',
		'avatar_q_page_a_size' => 'Avatar size on reactions:',
		'avatar_q_page_c_size' => 'Avatar size on reaction on reactions:',
		'avatar_q_page_q_size' => 'Avatar size on actions:',
		...
		'comment_on_as' => 'Allow reaction on reactions on reactions:',
		'comment_on_qs' => 'Allow reaction on reactions on actions:',
		...
		'default_sidebar' => "Welcome to ^ discussion website, where you interacte with the CATO2 community.",
		'default_subject' => 'A message from ^',
		'default_suffix' => 'Q&A',
		'do_ask_check_qs' => 'Check for similar actions when adding:',
		'do_close_on_select' => 'Close actions with a selected reaction:',
		'do_complete_tags' => 'Show matching tags while typing:',
		'do_count_q_views' => 'Count the number of action views:',
		'do_example_tags' => 'Show example tags based on action:',
		'editor_for_as' => 'Default editor for reactions:',
		'editor_for_cs' => 'Default editor for reaction on reactions:',
		'editor_for_qs' => 'Default editor for actions:',
		'email_privacy' => 'Privacy note for email addresses - HTML allowed:',
		'extra_field_active' => 'Custom field for extra information on add action form:',
		'extra_field_display_label' => 'Show the extra information on action pages with label:',
		'extra_field_display' => 'Show the extra information on action pages',
		'feed_for_activity' => 'Feed for recent activity:',
		'feed_for_hot' => 'Feed for hot actions:',
		'feed_for_qa' => 'Feed for recent actions and reactions:',
		'feed_for_questions' => 'Feed for recent actions:',
		'feed_for_search' => 'Feeds for search results:',
		'feed_for_tag_qs' => 'Feed for each tag\'s actions:',
		'feed_for_unanswered' => 'Feed for actions without a reaction:',
		...
		'follow_on_as' => 'Allow actions to be related to reactions:',
		'from_email' => 'Sender address for messages from site:',
		'hot_weight_a_age' => 'Action has a new reaction:',
		'hot_weight_answers' => 'Action has many reactions:',
		'hot_weight_q_age' => 'Action is new:',
		'hot_weight_views' => 'Action has many views:',
		'hot_weight_votes' => 'Action has many up votes:',
		...
		'match_4' => 'Wider',
		'match_5' => 'Widest',
		'match_ask_check_qs' => 'Similar actions matching:',
		'match_example_tags' => 'Example tags matching:',
		'match_related_qs' => 'Related actions matching:',
		'max_len_q_title' => 'Maximum length of action title:',
		'max_num_q_tags' => 'Maximum number of tags:',
		'max_rate_ip_as' => 'Rate limit for adding reactions:',
		'max_rate_ip_cs' => 'Rate limit for posting reaction on reactions:',
		...
		'max_rate_ip_qs' => 'Rate limit for adding actions:',
		...
		'max_rate_user_as' => 'Maximum reactions per user per hour:',
		'max_rate_user_cs' => 'Maximum reaction on reactions per user per hour:',
		'max_rate_user_flags' => 'Maximum flags per user per hour:',
		'max_rate_user_messages' => 'Maximum private messages per user per hour:',
		'max_rate_user_qs' => 'Maximum actions per user per hour:',
		'max_rate_user_uploads' => 'Maximum uploads per user per hour:',
		'max_rate_user_votes' => 'Maximum votes per user per hour:',
		'min_len_a_content' => 'Minimum length of reaction:',
		'min_len_c_content' => 'Minimum length of reaction on reaction:',
		'min_len_q_content' => 'Minimum length of action body:',
		'min_len_q_title' => 'Minimum length of action title:',
		...
		'notify_admin_q_post' => 'Email this address when an action is posted',
		'notify_users_default' => 'Check email notification box by default:',
		'option_default' => 'Default',
		'page_size_activity' => 'Length of All Activity page:',
		'page_size_ask_check_qs' => 'Maximum similar actions to show:',
		'page_size_ask_tags' => 'Maximum tag hints to show:',
		'page_size_home' => 'Length of Q&A page:',
		'page_size_hot_qs' => 'Length of Hot! page:',
		'page_size_q_as' => 'Maximum reactions per page:',
		'page_size_qs' => 'Length of Actions page:',
		'page_size_related_qs' => 'Maximum related actions:',
		'page_size_search' => 'Search results per page:',
		'page_size_tag_qs' => 'Actions on each tag page:',
		'page_size_tags' => 'Length of Tags page:',
		'page_size_una_qs' => 'Length of Unreacted page:',
		...
		'place_side_below_categories' => 'Side panel - Below issues',
		'place_side_below_sidebar' => 'Side panel - Below sidebar box',
		'place_side_last' => 'Side panel - Last',
		'place_side_top' => 'Side panel - Top',
		'points_a_selected' => 'Having your reaction selected as the best:',
		'points_a_voted_max_gain' => 'Limit from up votes on each reaction:',
		'points_a_voted_max_loss' => 'Limit from down votes on each reaction:',
		'points_base' => 'Add for all users:',
		'points_multiple' => 'Multiply all points:',
		'points_per_a_voted_down' => 'Per down vote on your reaction:',
		'points_per_a_voted_up' => 'Per up vote on your reaction:',
		'points_per_q_voted_down' => 'Per down vote on your action:',
		'points_per_q_voted_up' => 'Per up vote on your action:',
		'points_post_a' => 'Posting a reaction:',
		'points_post_q' => 'Posting an action:',
		'points_q_voted_max_gain' => 'Limit from up votes on each action:',
		'points_q_voted_max_loss' => 'Limit from down votes on each action:',
		'points_select_a' => 'Selecting a reaction for your action:',
		'points_vote_down_a' => 'Voting down a reaction:',
		'points_vote_down_q' => 'Voting down an action:',
		'points_vote_up_a' => 'Voting up a reaction:',
		'points_vote_up_q' => 'Voting up an action:',
		'q_urls_remove_accents' => 'Remove accents from action URLs:',
		'q_urls_title_length' => 'Action title length in URLs:',
		'search_module' => 'Use search module:',
		'show_a_form_immediate' => 'Show reaction form immediately:',
		'show_always' => 'Always',
		'show_c_reply_buttons' => 'Show reply button on reaction on reactions:',
		'show_custom_answer' => 'Custom message on reaction form - HTML allowed:',
		'show_custom_ask' => 'Custom message on add action form - HTML allowed:',
		'show_custom_comment' => 'Custom message on reaction on reaction form - HTML allowed:',
		...
		'show_selected_first' => 'Move selected reaction to the top:',
		...
		'show_view_counts' => 'Show view count in action lists:',
		...
		'sort_answers_by' => 'Sort reactions by:',
		'sort_time' => 'Time',
		'sort_votes' => 'Votes',
		'suspend_register_users' => 'Temporarily suspend new user registrations:',
		'tag_separator_comma' => 'Use comma as the only tag separator:',
		'tags_or_categories' => 'Action classification:',
		'votes_separated' => 'Show separate up and down votes:',
		'voting_on_as' => 'Allow voting on reactions:',
		'voting_on_q_page_only' => 'Allow voting on action page only:',
		'voting_on_qs' => 'Allow voting on actions:',
	);
