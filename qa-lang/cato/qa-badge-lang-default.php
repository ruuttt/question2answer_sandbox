<?php
	return array(
		...
		'nice_question'=>'Nice Action',
		'good_question'=>'Good Action',
		'great_question'=>'Great Action',

		'notable_question'=>'Notable Action',
		'popular_question'=>'Popular Action',
		'famous_question'=>'Famous Action',

		'nice_answer'=>'Nice Reaction',
		'good_answer'=>'Good Reaction',
		'great_answer'=>'Great Reaction',
		...
		'nice_question_desc'=>'Action received +# upvote',
		'good_question_desc'=>'Action received +# upvote',
		'great_question_desc'=>'Action received +# upvote',

		'notable_question_desc'=>'Added action received # ^view^views',
		'popular_question_desc'=>'Added action received # ^view^views',
		'famous_question_desc'=>'Added action received # ^view^views',
		
		'nice_answer_desc'=>'Reaction received +# upvote',
		'good_answer_desc'=>'Reaction received +# upvote',
		'great_answer_desc'=>'Reaction received +# upvote',

		'nice_answer_old_desc'=>'Received $nice_answer badge in response to an action more than # ^day^days old',
		'good_answer_old_desc'=>'Received $good_answer badge in response to an action more than # ^day^days old',
		'great_answer_old_desc'=>'Received $great_answer badge in response to an action more than # ^day^days old',
		
		'gifted_desc'=>'# ^answer^reactions selected as best answer',
		'wise_desc'=>'# ^answer^reactions selected as best answer',
		'enlightened_desc'=>'# ^answer^reactions selected as best answer',

		'grateful_desc'=>'Selected # ^answer^reactions as best reaction',
		'respectful_desc'=>'Selected # ^answer^reactions as best reaction',
		'reverential_desc'=>'Selected # ^answer^reactions as best reaction',
		...
		'asker_desc'=>'Added # ^question^actions',
		'questioner_desc'=>'Added # ^question^actions',
		'inquisitor_desc'=>'Added # ^question^actions',

		'answerer_desc'=>'Posted # ^answer^reactions',
		'lecturer_desc'=>'Posted # ^answer^reactions',
		'preacher_desc'=>'Posted # ^answer^reactions',

		'commenter_desc'=>'Posted # ^comment^reactions on reaction',
		'commentator_desc'=>'Posted # ^comment^reactions on reaction',
		'annotator_desc'=>'Posted # ^comment^reactions on reaction',
		...
		'reader_desc'=>'Read total of # ^question^actions',
		'avid_reader_desc'=>'Read total of # ^question^actions',
		'devoted_reader_desc'=>'Read total of # ^question^actions',
